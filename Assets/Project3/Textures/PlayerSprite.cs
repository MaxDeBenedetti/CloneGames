...
public class PlayerSprite : MonoBehaviour {
	...
	private float _facing = PlayerShoot.facing;
    ...
    void Update () {
        ...
        if (width != _width || height != _height || spriteNum != _spriteNum || _facing != PlayerShoot.facing){
            _width = width;
            _height = height;
    ...
    public void UpdateMesh() {
        ...
        verts[0] = new Vector3(-width *facing / 2.0f, -height/2.0f, 0);
        verts[1] = new Vector3(width *facing/ 2.0f, -height/2.0f, 0);
        verts[2] = new Vector3(width *facing/ 2.0f, height/2.0f, 0);
        verts[3] = new Vector3(-width *facing/ 2.0f, height/2.0f, 0);
